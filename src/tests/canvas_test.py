...
class CanvasTest(unittest.TestCase):
    ...
    def test_splitting_a_ppm(self):
        ...
        with open("test2.ppm", 'r') as file:
            ...
            self.assertEqual(lines[3], "255 204 153 255 204 153 255 204 153 255 204 153 255 204 153 255 204\n")
            self.assertEqual(lines[4], "153 255 204 153 255 204 153 255 204 153 255 204 153\n")
            self.assertEqual(lines[5], "255 204 153 255 204 153 255 204 153 255 204 153 255 204 153 255 204\n")
            self.assertEqual(lines[6], "153 255 204 153 255 204 153 255 204 153 255 204 153\n")
