        ...
        with open(file_name, 'a') as file:
            ...
            for i in range(self.height):
                ...
                for j in range(self.width):
                    # for each pixel
                    canvas_red = _clamp_canvas_value(
                        self._canvas[i][j].red) * 255.0
                    canvas_green = _clamp_canvas_value(
                        self._canvas[i][j].green) * 255.0
                    canvas_blue = _clamp_canvas_value(
                        self._canvas[i][j].blue) * 255.0

                    if len(current_line) + \
                            len(str(floor(canvas_red))) + 1 <= 70:
                        current_line = current_line + \
                            str(floor(canvas_red)) + " "
                    else:
                    ...
                    if len(current_line) + \
                            len(str(floor(canvas_green))) + 1 <= 70:
                        current_line = current_line + \
                            str(floor(canvas_green)) + " "
                    else:
                        current_line = current_line.strip()
                        current_line = current_line + "\n"
                        file.write(current_line)
                    ...
                    if len(current_line) + \
                            len(str(floor(canvas_blue))) + 1 <= 70:
                        current_line = current_line + \
                            str(floor(canvas_blue)) + " "
                    else:
                        current_line = current_line.strip()
                        current_line = current_line + "\n"
                        file.write(current_line)
